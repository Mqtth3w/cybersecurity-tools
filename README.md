...
- [secNotes.py](./secNotes.py) Data confidentiality and integrity with GUI. To encrypt/decrypt text files or similar.
- [secImgs.py](./secImgs.py) Data confidentiality and integrity with GUI. To encrypt/decrypt all images in a folder.
